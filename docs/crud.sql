...
ALTER TABLE `contacts` ADD `images` VARCHAR(255) NOT NULL AFTER `title`;

ALTER TABLE `contacts` CHANGE `images` `images` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL AFTER `id`